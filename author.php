        ...
        <div class="row">
            <div class="col-md-8">
              ...
              <div class="post-container">
                ...
                ?>
                <h2 class="page-heading">All ADs By - <?php echo $row1['username']; ?></h2>
                <?php
                  ...
                  $sql = "SELECT post.post_id, post.title,post.ad_price,post.ad_address, post.description,post.post_date,post.author,
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="inner-content clearfix">
                                ...
                                <h3><a>Address : <?php echo $row['ad_address']; ?></a></h3>
