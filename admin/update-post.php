  ...
  <div class="row">
    ...
    <div class="col-md-offset-3 col-md-6">
      <?php
        ...
        $post_id = $_GET['id'];
        $sql = "SELECT post.post_id, post.title,post.ad_price,post.ad_address,post.description,post.post_img,
      ...
      ?>
        ...
        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ad_price"  class="form-control" id="exampleInputUsername" value="<?php echo $row['ad_price']; ?>">
            </div>
            <div class="form-group">
