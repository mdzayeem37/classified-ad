<?php include "header.php"; ?>
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading" style="">All ADs</h1>
              </div>
              <div class="col-md-2">
                  <a class="add-new" href="add-post.php">Post - AD</a>
              </div>
              <div class="col-md-12">
                <?php
                  ...
                  if($_SESSION["user_role"] == '1'){
                    ...
                    $sql = "SELECT post.post_id, post.title,post.ad_price,post.ad_address,post.description,post.post_date,
                ...
                ?>
                  ...
                  echo "<h3 style='background-color:white;color:red;text-align:center;'>No Results Found.</h3>";
                }
                // show pagination
                if($_SESSION["user_role"] == '1'){
                  /* select query of post table for admin user */
