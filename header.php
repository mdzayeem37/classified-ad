  ...
  switch($page){
    ...
    case "category.php":
      if(isset($_GET['cid'])){
        ...
        $result_title = mysqli_query($conn,$sql_title) or die("Tile Query Failed");
        $row_title = mysqli_fetch_assoc($result_title);
        $page_title = $row_title['category_name'] . " ADs";
      }else{
        $page_title = "No Post Found";
      }
      break;
        ...
        <div class="row">
            ...
            <div class=" col-md-offset-4 col-md-4">
              <?php
                ...
                ?>
                <div>
                        <a href="login.php" class="admin-logout" style="font-size: 18px;padding:10px;color:black;;background:white;border:2px solid #000;" ><strong>Post/Sell-AD</strong></a>
              </div>
            </div>
            <!-- /LOGO -->
               <!-- LOGIN -->
